  ...
  return (
    <div className="relative w-full h-full">
      ...
      <svg viewBox="0 0 320 320" className="w-full h-full">
          ...
          <g style={{ animation: "cloudDrift 4s ease-in-out infinite" }}>
            ...
            {Array.from({ length: critical ? 14 : 8 }).map((_, i) => (
              <line
                ...
                strokeLinecap="round"
                style={{ animation: `rainDrop ${critical ? 0.7 : 1.2}s ease-in ${i * 0.1}s infinite` }}
              />
            ))}
          </g>
        )}
        ...
        <g>
          {/* trunk */}
          <path d="M150 250 L150 130 Q152 120 158 118 Q168 120 170 130 L170 250 Z" fill="#7a4a20" />
          <path d="M154 245 L154 140" stroke="#4a2d13" strokeWidth="2" opacity="0.5" />
          {/* branches */}
          <path d="M160 170 Q120 160 96 150" stroke="#7a4a20" strokeWidth="7" fill="none" strokeLinecap="round" />
          <path d="M160 160 Q210 150 236 138" stroke="#7a4a20" strokeWidth="7" fill="none" strokeLinecap="round" />
          {/* canopy */}
          <g style={{ animation: `${critical ? "leafToss" : "leafSway3"} ${critical ? "1.4s" : "3.6s"} ease-in-out infinite`, transformOrigin: "160px 100px" }}>
