  ...
  return (
    <div className="relative w-full h-full">
      ...
      <svg viewBox="0 0 320 320" className="w-full h-full">
        ...
        {/* Whole tree group sways as one */}
        <g filter="url(#tree-soft)" style={{ animation: `${critical ? "treeDroop" : "treeSway"} 4.5s ease-in-out infinite`, transformOrigin: "160px 260px" }}>
          ...
          {capped >= 8 && (
            <g>
              ...
              {[[130, 130], [180, 120], [200, 160], [140, 170], [170, 155], [110, 145]].map(([x, y], i) => (
                <g key={i}>
        ...
        {wilt && (
          <g opacity="0.35">
            <text x="160" y="60" textAnchor="middle" fontSize="20">💧</text>
          </g>
        )}
      </svg>
    </div>
